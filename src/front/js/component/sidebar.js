...
export const Sidebar = () => {
  ...
  <div className="d-flex">
    <div id="sidebar">
      <div className="p-2">
        <a href="#" className="navbar-brand text-center text-light w-100 p-4 border-bottom">
          Sidebar
        </a>
      </div>
      <div id="sidebar-accordion" class="accordion">
        <div className="list-group">
          <a href="#dashboard-items" data-toggle="collapse" aria-expanded="false"
            ...
            <i className="fa fa-tachometer mr-3" aria-hidden="true"></i>Dashboard
          </a>
          <div id="dashboard-items" className="collapse" data-parent="#sidebar-accordion">
            <a href="#" className="list-group-item list-group-item-action bg-dark text-light pl-5">
              Item 1
            </a>
            <a href="#" className="list-group-item list-group-item-action bg-dark text-light pl-5">
              Item 2
          ...
          <div id="profile-items" className="collapse" data-parent="#sidebar-accordion">
            <a href="#" className="list-group-item list-group-item-action bg-dark text-light pl-5">
              Item 1
            </a>
            <a href="#" className="list-group-item list-group-item-action bg-dark text-light pl-5">
          ...
          <a href="#" className="list-group-item list-group-item-action bg-dark text-light">
            <i className="fa fa-shopping-cart mr-3" aria-hidden="true"></i>Buy Now!
          </a>
